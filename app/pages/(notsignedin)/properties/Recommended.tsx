            ...
            <div className="flex w-full gap-4 overflow-x-auto pt-10">
              ...
              >
                <div className="relative flex h-full w-full flex-col items-center justify-center">
                  <p className="w-[70%]  py-5 text-center text-[22px] font-bold tracking-[-4%] text-white">
                    SIGN IN TO GET RECOMMENDATION
                  </p>
                  <div className="absolute bottom-0 min-h-[50px] w-full">
                    <div className="flex min-h-[50px] w-full justify-between bg-white  px-4 py-3 pb-2 opacity-60">
                      <div>
                    ...
                    <div className="flex h-[50px] w-full items-center justify-center overflow-hidden rounded-b-[10px] bg-[#7F8184] bg-contain py-4 text-left text-base font-normal text-white">
                      with modern features and facilities. 4 500 m²
                    </div>
                  </div>
                </div>
              </div>
